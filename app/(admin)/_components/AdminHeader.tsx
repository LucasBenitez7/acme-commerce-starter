...
export function AdminHeader({ user }: Props) {
  ...
  return (
    <header className="sticky top-0 z-[100] w-full border-b bg-background h-16 grid grid-cols-[1fr_auto_1fr] items-center px-4">
      <div className="flex justify-self-start items-center">
        <Sheet open={open} onOpenChange={setOpen} modal={false}>
          ...
          <SheetContent
            side="left"
            className="w-full sm:w-[300px] p-0 outline-none pt-2 border-r"
          >
